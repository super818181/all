...
var viewMethods = {
    ...
    roundEnd: function() {
        ...
        DynLoading.goto('xx' + globalData.maxCount, 'i=' + globalData.roomNumber);
    },
    ...
    throwBet: function (e) {
        if (7 == appData.player[0].account_status && !appData.player[0].is_banker && appData.coinSelect > 0) {
            ...
            if((appData.tempBet + appData.coinSelect)>appData.ruleInfo.upper_limit){
                methods.showResultTextFunc('下注超出上限');
                return
            }else{
                appData.tempBet += appData.coinSelect;
