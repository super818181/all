...
var socketModule = {
    ...
    processGameRule: function (e) {
        e.data.ticket_type && (appData.ruleInfo.ticket = e.data.ticket_type,
        ...
        1 == appData.ruleInfo.isCardfive && 1 == appData.ruleInfo.isCardbomb && 1 === appData.ruleInfo.isCardtiny ?
    ...
    processPrepareJoinRoom: function (e) {
        ...
        if (1 == appData.ruleInfo.isCardfive && 1 == appData.ruleInfo.isCardbomb && 1 === appData.ruleInfo.isCardtiny) {
            appData.ruleInfo.rule_height = "8vh"
        } else {
            if (1 == appData.ruleInfo.isCardfive || 1 == appData.ruleInfo.isCardbomb || 1 === appData.ruleInfo.isCardtiny) {
                appData.ruleInfo.rule_height = "4vh";
            ...
            for (var a = 0; a < e.all_gamer_info.length; a++)
                if (appData.player[t].serial_num == e.all_gamer_info[a].serial_num) {
                    ...
                    if (appData.player[t].card_open.length < 1 || void 0 == appData.player[t].card_open) {
                        appData.player[t].card_open = [-1, -1, -1, -1, -1];
                    }
                }
        ...
        for (a = 0; a < 9; a++)
            for (var t = 0; t < e.data.length; t++)
                if (appData.player[a].serial_num == e.data[t].serial_num) {
                    ...
                    appData.player[a].card_open = getComboCards(e.data[t].cards.concat());
    ...
    processUpdateAccountShow: function (e) {
        for (var t = 0; t < appData.player.length; t++)
            if (appData.player[t].account_id == e.data.account_id) {
                ...
                appData.player[t].card_open = e.data.combo_array.concat();
                ...
                if (0 == appData.player[t].is_audiobull && appData.player[t].account_status >= 8) {
                    var a = "";
                    a = 1 == appData.player[t].card_type ? "audioBull0" :
                        4 == appData.player[t].card_type ? "audioBull10" :
                            5 == appData.player[t].card_type ? "audioBull11" :
                                6 == appData.player[t].card_type ? "audioBull12" :
                                    7 == appData.player[t].card_type ? "audioBull13" :
                                        "audioBull" + appData.player[t].combo_point;
                    setTimeout(function () {
                        mp3AudioPlay(a)
                    }, 100);
    ...
    processWin: function (e) {
        ...
        if (appData.player[0].account_status >= 8 && 0 == appData.player[0].is_audiobull) {
            ...
            setTimeout(function () {
                mp3AudioPlay(1 == r ? "audioBull0" : 4 == r ? "audioBull10" : 5 == r ? "audioBull11" : 6 == r ? "audioBull12" : 7 == r ? "audioBull13" : "audioBull" + o)
            }, 200);
...
var viewMethods = {
    ...
    resetMyAccountStatus: function () {
        if (6 != appData.player[0].account_status || appData.isFinishBankerAnimate) {
            ...
            if (3 == appData.player[0].account_status) {
                ...
                appData.player[0].is_showCard = !0;
                if (1 == appData.clickCard4 && 1 == appData.clickCard5) {
    ...
    resetCardOver: function (e) {
        if (1 == e) {
            ...
            $(".cardOver .card" + e + "41").css("right", "13.5vh");
            $(".cardOver .card" + e + "51").css("right", "15.5vh");
        } else if (5 == e) {
            $(".cardOver .card511").css("right", "9.5vh");
            $(".cardOver .card521").css("right", "11.5vh");
            $(".cardOver .card531").css("right", "13.5vh");
            $(".cardOver .card541").css("right", "15.5vh");
            $(".cardOver .card551").css("right", "17.5vh");
        } else if (6 == e) {
            $(".cardOver .card611").css("left", "9.5vh");
            $(".cardOver .card621").css("left", "11.5vh");
            $(".cardOver .card631").css("left", "13.5vh");
            $(".cardOver .card641").css("left", "15.5vh");
            $(".cardOver .card651").css("left", "17.5vh");
        } else if (7 == e || 8 == e || 9 == e) {
            $(".cardOver .card" + e + "11").css("left", "7.5vh");
            $(".cardOver .card" + e + "21").css("left", "9.5vh");
            $(".cardOver .card" + e + "31").css("left", "11.5vh");
            $(".cardOver .card" + e + "41").css("left", "13.5vh");
            $(".cardOver .card" + e + "51").css("left", "15.5vh");
        }
    },
    myCardOver: function (e) {
        if (1 != appData.player[0].is_showbull) {
            ...
            if (e) {
                setTimeout(function () {
                    $(".myCards .card00").animate({left: "34%"}, 400);
                    $(".myCards .card01").animate({left: "40%"}, 400);
                    $(".myCards .card02").animate({left: "46%"}, 400);
                    $(".myCards .card03").animate({left: "61%"}, 400);
                    $(".myCards .card04").animate({left: "68%"}, 400);
                }, 0);
            } else {
                setTimeout(function () {
                    $(".myCards .card00").animate({left: "34%"}, 400);
                    $(".myCards .card01").animate({left: "42%"}, 400);
                    $(".myCards .card02").animate({left: "50%"}, 400);
                    $(".myCards .card03").animate({left: "58%"}, 400);
                    $(".myCards .card04").animate({left: "66%"}, 400);
                }, 0);
            }
    ...
    cardOver: function (e, t) {
        if (e > 1 && 1 != appData.player[e - 1].is_showbull) {
            ...
            setTimeout(function () {
                if (2 == e || 3 == e || 4 == e) {
                    $(".cardOver .card" + e + "11").animate({right: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "21").animate({right: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "31").animate({right: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "41").animate({right: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "51").animate({right: "7.5vh"}, 250);
                    if (t) {
                        setTimeout(function () {
                            ...
                            $(".cardOver .card" + e + "41").animate({right: "14.5vh"}, 400);
                            $(".cardOver .card" + e + "51").animate({right: "16.5vh"}, 400);
                        }, 250);
                    } else {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "21").animate({right: "9.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({right: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({right: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "51").animate({right: "15.5vh"}, 400);
                        }, 250);
                    }
                } else if (7 == e || 8 == e || 9 == e) {
                    $(".cardOver .card" + e + "11").animate({left: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "21").animate({left: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "31").animate({left: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "41").animate({left: "7.5vh"}, 250);
                    $(".cardOver .card" + e + "51").animate({left: "7.5vh"}, 250);
                    if (t) {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "11").animate({left: "16.5vh"}, 400);
                            $(".cardOver .card" + e + "21").animate({left: "14.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({left: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({left: "9.5vh"}, 400);
                        }, 250);
                    } else {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "11").animate({left: "15.5vh"}, 400);
                            $(".cardOver .card" + e + "21").animate({left: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({left: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({left: "9.5vh"}, 400);
                        }, 250);
                    }
                } else if (5 == e) {
                    $(".cardOver .card" + e + "11").animate({right: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "21").animate({right: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "31").animate({right: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "41").animate({right: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "51").animate({right: "9.5vh"}, 250);
                    if (t) {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "21").animate({right: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({right: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({right: "16.5vh"}, 400);
                            $(".cardOver .card" + e + "51").animate({right: "18.5vh"}, 400);
                        }, 250);
                    } else {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "21").animate({right: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({right: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({right: "15.5vh"}, 400);
                            $(".cardOver .card" + e + "51").animate({right: "17.5vh"}, 400);
                        }, 250);
                    }
                } else if (6 == e) {
                    $(".cardOver .card" + e + "11").animate({left: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "21").animate({left: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "31").animate({left: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "41").animate({left: "9.5vh"}, 250);
                    $(".cardOver .card" + e + "51").animate({left: "9.5vh"}, 250);
                    if (t) {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "11").animate({left: "18.5vh"}, 400);
                            $(".cardOver .card" + e + "21").animate({left: "16.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({left: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({left: "11.5vh"}, 400);
                        }, 250);
                    } else {
                        setTimeout(function () {
                            $(".cardOver .card" + e).addClass("card-flipped");
                            $(".cardOver .card" + e + "11").animate({left: "17.5vh"}, 400);
                            $(".cardOver .card" + e + "21").animate({left: "15.5vh"}, 400);
                            $(".cardOver .card" + e + "31").animate({left: "13.5vh"}, 400);
                            $(".cardOver .card" + e + "41").animate({left: "11.5vh"}, 400);
                            $(".cardOver .card" + e + "51").animate({left: "9.5vh"}, 400);
                        }, 250);
                    }
                }
            }, 1);
    ...
    roundEnd: function () {
        ...
        DynLoading.goto('dxb' + globalData.maxCount, 'i=' + globalData.roomNumber);
    },
    updateAllPlayerStatus: function () {
        for (var e = 0; e < appData.player.length; e++) {
            ...
            if (appData.player[e].card_type >= 1) {
                var t = 0, a = parseInt(appData.player[e].card_type);
                appData.player[e].is_bull = !1;
                if (1 == a) {
                    t = 0;
                } else if (4 == a) {
                    t = 10;
                    appData.player[e].is_bull = !0;
                } else if (5 == a) {
                    t = 11;
                    appData.player[e].is_bull = !0;
                } else if (6 == a) {
                ...
                appData.player[e].bullImg = globalData.fileUrl + "fiesc/images/bull_yh/bull" + t + ".png"
            }
...
var audioModule = {
    ...
    loadAllAudioFile: function () {
        if (4 != globalData.roomStatus && 1 != isLoadAudioFile) {
            ...
            var e = ["nobull.m4a", "bull1.m4a", "bull2.m4a", "bull3.m4a", "bull4.m4a", "bull5.m4a", "bull6.m4a", "bull7.m4a", "bull8.m4a", "bull9.m4a",
                "bull10.m4a", "bullflower.m4a", "bullbomb.m4a", "bulltiny.m4a", "coin.mp3", "audio1.m4a"];
            var t = ["audioBull0", "audioBull1", "audioBull2", "audioBull3", "audioBull4", "audioBull5", "audioBull6", "audioBull7", "audioBull8", "audioBull9",
                "audioBull10", "audioBull11", "audioBull12", "audioBull13", "audioCoin", "audio1"];
            for (a = 0; a < e.length; a++)
                this.loadAudioFile(this.baseUrl + "files/audio/bull/" + e[a], t[a]);
...
var methods = {
    ...
    closeHomeAlert: viewMethods.closeHomeAlert,
...
function getShareContent() {
    ...
    if (1 == appData.ruleInfo.isCardfive || 1 == appData.ruleInfo.isCardbomb || 1 == appData.ruleInfo.isCardtiny) {
        var e = "  牌型：";
        if (1 == appData.ruleInfo.isCardfive) {
            e += " 五花牛 ";
        }
        if (1 == appData.ruleInfo.isCardbomb) {
            e += " 炸弹牛 ";
        }
        if (1 == appData.ruleInfo.isCardtiny) {
            e += " 五小牛 ";
        }
        shareContent += e;
    }
...
wx.ready(function () {
    ...
    wx.onMenuShareTimeline({
        ...
        imgUrl: globalData.fileUrl + "files/images/dxbull/share_icon.png",
        success: function () {
        },
        cancel: function () {
        }
...
function liuliuCreateRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
    var pics = [globalData.fileUrl + 'files/images/dxbull/rank_frame.jpg', globalData.fileUrl + 'files/images/common/people_bg.png', globalData.fileUrl + 'files/images/common/ranking_icon.png'];
    if (users.length > 6) {
