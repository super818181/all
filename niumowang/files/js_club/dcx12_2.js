...
var httpModule={
    getInfo: function() {
        ...
        // Vue.http.post('getInfo', postData).then(function(response) {
        //
...
var viewMethods={
    ...
    clickSitDown:function(){appData.isShowGameAlert = !1,appData.isShowAlert = !1, socketModule.sendJoinRoom()},
    ...
    closeEnd:function(){},
    roundEnd:function(){
        window.location.href = globalData.baseUrl+'home/dcx?i='+globalData.roomNumber+'_&v='+(new Date().getTime());
        chooseBigWinner();
        $(".ranking .rankBack").css("opacity","1");
        $(".roundEndShow").show();
        setTimeout(function(){
...
function liuliuCreateRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
    var pics = [globalData.fileUrl+'files/images/dcx/rank_frame2.jpg', globalData.fileUrl+'files/images/common/people_bg.png', globalData.fileUrl+'files/images/common/ranking_icon.png'];
    if (users.length > 6) {
