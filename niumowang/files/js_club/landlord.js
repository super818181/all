...
var viewMethods = {
    ...
    roundEnd: function () {
        window.location.href = globalData.baseUrl+'home/dz?i='+globalData.roomNumber+'_&v='+(new Date().getTime());
    },
...
$(function () {
    ...
    window.onload = function () {
        ...
        var maxCount='';
        if(globalData.maxCount){
            maxCount=globalData.maxCount+ '人';
        }
        copyLink.value = globalData.hallName + ':' + maxCount + globalData.gameName + "(房间:" + globalData.roomNumber + ') \n'  +window.location.href;
