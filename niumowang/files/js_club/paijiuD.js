    ...
    processAllGamerInfo:function(e){
        ...
        for(a=0;a<8;a++)
            for(var t=0;t<e.data.length;t++)
                appData.player[a].serial_num==e.data[t].serial_num&&(
                    ...
                    8==appData.player[a].account_status&&(
                        a>0?(
                            ...
                            // appData.player[a].gtBankerOne=e.data[t].cardGroupOne.gtBanker,
                            // appData.player[a].gtBankerTwo=e.data[t].cardGroupTwo.gtBanker
                        )
                    )
                );
        ...
        for(var t=0;t<appData.player.length;t++)
            if(appData.player[t].account_id==e.data.account_id){
                ...
                if(appData.player[t].multiples>=1){
                    ...
                    setTimeout(function(){mp3AudioPlay("audioTimes"+a)},100)
                }
                break
            }
        viewMethods.resetMyAccountStatus(),
...
var viewMethods={
    ...
    reDeal:function(){appData.isDealing||(appData.isDealing=!0,m4aAudioPlay("audio1"),appData.game.cardDeal=1,setTimeout(function(){appData.game.cardDeal=2,setTimeout(function(){appData.game.cardDeal=3,setTimeout(function(){appData.game.cardDeal=4,setTimeout(function(){appData.game.cardDeal=5,setTimeout(function(){appData.isDealing=!1,viewMethods.resetMyAccountStatus(),appData.showClockRobText=!0,5==appData.ruleInfo.banker_mode&&1==appData.game.round&&viewMethods.updateAllPlayerStatus()},100)},100)},100)},100)},100))},
    resetMyAccountStatus:function(){ (6!=appData.player[0].account_status||appData.isFinishBankerAnimate)&&(viewMethods.resetShowButton(),3==appData.player[0].account_status?appData.showRob=!0:4==appData.player[0].account_status?appData.showNotRobText=!0:5==appData.player[0].account_status?appData.showRobText=!0:6==appData.player[0].account_status?(1==appData.player[0].is_banker?(appData.showBankerCoinText=!0,appData.player[0].is_showCard=!0):appData.isFinishBankerAnimate&&(appData.showTimesCoin=!0),appData.player[0].is_showCard=!0):7==appData.player[0].account_status?(appData.player[0].is_showCard=!0,viewMethods.seeMyCard()):8==appData.player[0].account_status?(appData.player[0].is_showCard=!1,appData.player[0].is_GroupCard=!0,appData.player[0].open_left=!0,appData.player[0].open_right=!0,setTimeout(function(){$(".memberBullWin111").fadeIn(300),$(".memberBullWin122").fadeIn(300)},1e3)):9==appData.player[0].account_status&&(appData.player[0].open_left=!0,appData.player[0].open_right=!0,setTimeout(function(){$(".memberBullWin111").fadeIn(300),$(".memberBullWin122").fadeIn(300)},1e3)))},
    updateAllPlayerStatus:function(){
        for(var e=0;e<appData.player.length;e++){
            ...
            appData.player[e].multiples>0&&(appData.player[e].timesImg=globalData.fileUrl+"files/images/bull/text_times"+appData.player[e].multiples+".png"),
            appData.player[e].bankerMultiples>0&&(appData.player[e].bankerTimesImg=globalData.fileUrl+"files/images/bull/text_times"+appData.player[e].bankerMultiples+".png");
    ...
    showMessage:function(){appData.isShowMessage=!0,disable_scroll(),setTimeout(function(){appData.bScroll?appData.bScroll.refresh():appData.bScroll=new BScroll(document.getElementById("message-box"),{startX:0,startY:0,scrollY:!0,scrollX:!1,click:!0})},10)},
    ...
    timeCountDown:function(){if(1!=isTimeLimitShow)return appData.game.time<=0?(isTimeLimitShow=!1,0):(isTimeLimitShow=!0,appData.game.time--,void(timeLimit=setTimeout(function(){isTimeLimitShow=!1,viewMethods.timeCountDown()},1e3)))},
    ...
    robBankerWithoutAnimate:function(){for(var e=0;e<appData.player.length;e++)appData.player[e].account_id==appData.bankerAccountId?(appData.player[e].is_banker=!0,bankerNum=appData.player[e].num):appData.player[e].is_banker=!1,$("#bankerAnimate"+appData.player[e].num).hide(),$("#bankerAnimate1"+appData.player[e].num).hide();setTimeout(function(){appData.showClockRobText=!1,appData.showClockBetText=!0,appData.isFinishBankerAnimate=!0,viewMethods.resetMyAccountStatus(),viewMethods.updateAllPlayerStatus()},10),appData.game.time=11,appData.game.time>0&&viewMethods.timeCountDown()},
...
var audioModule={
    ...
    playSound:function(e,t){
        ...
        if(a)try{
            a.source=null,a.source=audioModule.audioContext.createBufferSource(),a.source.buffer=a.buffer,a.source.loop=!1;var n=audioModule.audioContext.createGain();1==t?(a.source.loop=!0,n.gain.value=.7):n.gain.value=1,a.source.connect(n),n.connect(audioModule.audioContext.destination),a.source.start(0)
        }catch(e){}
    },
    ...
    loadAllAudioFile:function(){
        if(4!=globalData.roomStatus&&1!=isLoadAudioFile){
            isLoadAudioFile=!0,
            this.loadAudioFile(this.baseUrl+"files/audio/paijiuD/background3.mp3","backMusic");
            var e=["robn.m4a","rob.m4a","point0.m4a","point1.m4a","point2.m4a","point3.m4a","point4.m4a","point5.m4a","point6.m4a","point7.m4a","point8.m4a","point9.m4a","type2.m4a","type3.m4a","type4.m4a","type5.m4a","type6.m4a","type7.m4a","type8.m4a","type9.m4a","type10.m4a","type11.m4a","type12.m4a","type13.m4a","type14.m4a","type15.m4a","type16.m4a","type17.m4a","type18.m4a","type19.m4a","type20.m4a","type21.m4a","type22.m4a","type23.m4a","time1.m4a","time2.m4a","time3.m4a","time4.m4a","time5.m4a","time6.m4a","time8.m4a","time10.m4a","time12.mp3","coin.mp3","audio1.m4a"];
            var t=["audioNoBanker","audioRobBanker","point0","point1","point2","point3","point4","point5","point6","point7","point8","point9","type2","type3","type4","type5","type6","type7","type8","type9","type10","type11","type12","type13","type14","type15","type16","type17","type18","type19","type20","type21","type22","type23","audioTimes1","audioTimes2","audioTimes3","audioTimes4","audioTimes5","audioTimes6","audioTimes8","audioTimes10","audioTimes12","audioCoin","audio1"];
            for(a=0;a<e.length;a++)
                this.loadAudioFile(this.baseUrl+"files/audio/paijiuD/"+e[a],t[a]);
        }
    }
};
...
var methods={
    ...
    showGameRule:function(){4!=appData.roomStatus&&($(".createRoom .mainPart").css("height","60vh"),$(".createRoom .mainPart .blueBack").css("height","51vh"),appData.ruleInfo.isShowRule=!0)},
