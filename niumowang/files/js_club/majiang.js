...
var screenData = {
    ...
    initialize: function() {
        if (screenData.height > screenData.width) {
		    $("#app-main").width(screenData.height);
            $("#app-main").height(screenData.width);
...
var httpModule = {
    getInfo: function() {
        ...
        //     //     }
        //     // } else {
        //     //     controlMethod.showAlert(8, bodyData.result_message);
        //     // }
        //
        // }, function(response) {
        //
    ...
    applyClub: function () {
        var postData = {"account_id": userData.accountId, "club_id": appData.applyInfo.club_id};
        $.ajax({
            type: "POST",
            url: '/clubapi/join',
            data: postData,
...
var methods = {
    ...
    confirmAudioSetting: function(once) {
		...
		if(once == '1' && appData.musicOnce && appData.editAudioInfo.backMusic==1 && appData.editAudioInfo.messageMusic==1){
			...
			setTimeout(function(){stopSound('backMusic');},200);
			setTimeout(function(){playSound('backMusic', true);},500);           
...
console.log('appData.width',appData.width);
